...
- [ ] T018 [US1] Implement intent parsing for analytic and editorial needs in `src/beautivizf1/interpretation/intent_parser.py`
...
- [ ] T020 [P] [US1] Add unit tests for intent parsing and clarification outcomes in `tests/unit/test_intent_parser.py`
