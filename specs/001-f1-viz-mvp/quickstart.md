...
4. Vérifier qu'un manque de couverture ou une donnée incohérente bloque ou limite explicitement la sortie.
5. Vérifier manuellement que la visualisation produite reste lisible et cohérente avec les notes.
6. Vérifier qu'un artefact d'embed dédié est présent et exploitable pour une intégration web simple.
