...
**Validation**: Every story MUST include clear verification tasks. Manual validation is
acceptable first when it is explicit and reliable; add automated checks when risk,
repetition, or project maturity justifies it.

**Organization**: Tasks are grouped by user story to enable independent
implementation, verification, and review of each story.
...
- Only include tasks tied to approved scope; capture deferred ideas outside this file
- Add documentation or decision-log updates whenever a task changes shared understanding
...
- [ ] T004 Capture initial documentation and decision record scaffolding
...
> **NOTE: Define verification before implementation. Prefer failing automated
> checks first when they exist; otherwise write the manual validation steps
> explicitly.**
...
- [ ] T013 [US1] Document manual validation steps if automation is not yet justified
...
- [ ] T020 [US1] Update docs and decision record impacted by User Story 1
...
- [ ] T023 [US2] Document manual validation steps if automation is not yet justified
...
- [ ] T028 [US2] Update docs and decision record impacted by User Story 2
...
- [ ] T031 [US3] Document manual validation steps if automation is not yet justified
...
- [ ] T035 [US3] Update docs and decision record impacted by User Story 3
...
- [ ] TXXX [P] Additional automated checks in tests/unit/ or equivalent when justified
...
- Automated tests SHOULD be written and FAIL before implementation when they are part of the chosen validation approach
- Models before services
- Services before endpoints
- Core implementation before integration
- Documentation and decision updates before story closure
...
- Verify the chosen validation approach before implementing
